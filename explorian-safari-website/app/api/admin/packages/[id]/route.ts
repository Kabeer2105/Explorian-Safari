  ...
  try {
    ...
    const updatedPackage = await prisma.package.update({
      ...
      data: {
        ...
        exclusions,
        itinerary,
        duration_days: duration_days ? parseInt(duration_days) : 1,
        price_from: price_from ? parseFloat(price_from) : 0,
        currency,
        max_group_size: max_group_size ? parseInt(max_group_size) : 1,
        difficulty_level,
